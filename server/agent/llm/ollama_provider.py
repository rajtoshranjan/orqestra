...
class OllamaProvider(BaseLLMProvider):
    ...
    def stream(
        ...
        *,
        ...
        max_tokens: int = 4096,
        cacheable_prefix: str = "",  # noqa: ARG002 - local models cache nothing
    ) -> Iterator[LLMEvent]:
        import requests
        ...
        if self._context_window and not self._get_api_key():
        ...
        with response:
            ...
            for line in response.iter_lines():
                ...
                for call in message.get("tool_calls") or []:
                    ...
                    # Ollama issues no call ids; `ensure_tool_call_id` mints one
                    # so the engine can still pair the result back to the call.
                    tool_calls.append(
                        ToolCallRequested(
