...
type ProjectNotificationsBellProps = {
  /** Jumps to the annotation when it belongs to the open project. */
  onOpenAnnotation: (annotationId: string, projectId: string) => void;
};

export function ProjectNotificationsBell({
  onOpenAnnotation,
}: ProjectNotificationsBellProps) {
          ...
          {notifications.length === 0 ? (
            <div className="flex flex-col items-center gap-2 px-4 py-8 text-center">
              ...
              <p className="text-xs text-muted-foreground">
                Mentions, replies, and resolutions show up here.
              </p>
            </div>
          ) : (
