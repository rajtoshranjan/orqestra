...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn('border-b border-border bg-black/10', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    className={cn('divide-y divide-border text-xs', className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn('p-3 text-xs font-bold text-muted-foreground', className)}
    {...props}
  />
));
